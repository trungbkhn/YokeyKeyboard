...
public class RealtimeBlurViewKB extends View {
    ...
    public void setDecorView(View decorView, boolean isRealTime) {
        this.mDecorView = decorView;
        this.isRealTime = isRealTime;
        handingDecorView();
    }

    public void changeIsRealTime(boolean isRealTime){
        this.isRealTime = isRealTime;
        Log.d("duongcv", "changeIsRealTime: "+isRealTime);
        if(isRealTime && mDecorView!=null){
            Log.d("duongcv", "changeIsRealTime: not null");
            handingDecorView();
        }
    }

    public RealtimeBlurViewKB(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mBlurRadius = 100;
//        mDownsampleFactor = 4;
//        mOverlayColor = Color.parseColor("#a8a8a8");


        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RealtimeBlurView);
//        mBlurRadius = Hawk.get(AppConstant.HAWK_PERCENT_BLUR_BACKGROUND_KEYBOARD_THEME_CUSTOMIZE, 0);
...
//        }
    ...
    public void setTurnOnBlur(boolean turnOnBlur) {
        isShowBlur = turnOnBlur;
        if (turnOnBlur) {
//            mBlurRadius = Hawk.get(AppConstant.HAWK_PERCENT_BLUR_BACKGROUND_KEYBOARD_THEME_CUSTOMIZE, 0);
            setBlurRadius(mBlurRadius);
        } else {
...
//        handingDecorView();
    ...
    private void removeListenerDraw() {
        if (mDecorView != null) {
...
//    public void onEvent(BlurBackgroundThemeCustomize event) {
//        if (isShowBlur) {
//            listener = true;
//            setBlurRadius(event.getProgress());
//            EventBus.getDefault().removeStickyEvent(this);
//        }
//    }


    private void handingDecorView() {
        if (mDecorView != null) {
