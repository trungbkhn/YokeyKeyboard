...
public final class KeyboardLayoutSet {
    ...
    public boolean isTypeNumberKeyboard(){
        if (mParams!=null){
            return mParams.mMode == KeyboardId.MODE_PHONE ||  mParams.mMode == KeyboardId.MODE_NUMBER;
        }
        return false;
    }
    ...
    private Keyboard getKeyboard(final ElementParams elementParams, final KeyboardId id) {
        ...
        if(id.mElementId == KeyboardId.ELEMENT_EMOJI_FAVOURITE){
            return new Keyboard(new KeyboardParams());
        }
    ...
    public static final class Builder {
        ...
        public Builder(final Context context, @Nullable final EditorInfo ei) {
            ...
            Log.e("rgb keyboard ", "alo "+ params.mEditorInfo.privateImeOptions);
        ...
        public Builder setSubtype(@Nonnull final RichInputMethodSubtype subtype) {
          ...
          //  Log.e("rgb keyboard ", "alo ascii  "+ mParams.mEditorInfo.privateImeOptions);
        ...
        public RichInputMethodSubtype getStubtype(){
            return mParams.mSubtype;
        }
