...
public final class KeyboardRow {
    ...
    private final int mRowHeightEmoji;
...
//                R.styleable.Keyboard_rowHeight, params.mBaseHeight, params.mDefaultRowHeight);
        ...
        int mRowHeightTemp = (int) ResourceUtils.getDimensionOrFraction(keyboardAttr,
                R.styleable.Keyboard_rowHeight, params.mBaseHeight, params.mDefaultRowHeight);
        int mRowHeightTempEmoji = (int) ResourceUtils.getDimensionOrFraction(keyboardAttr,
                R.styleable.Keyboard_rowHeight, params.mBaseHeightEmoji, params.mDefaultRowHeightEmoji);
        keyboardAttr.recycle();
        float heightRowPercent = (float) mPrefs.getFloat(Constant.HEIGHT_ROW_KEY, Constant.VALUE_HEIGHT_DEFAULT_KEYBOARD);

//        mRowHeightEmoji = (int) (heightRowPercent * mRowHeightTemp);
        mRowHeight =  mRowHeightTemp;
        mRowHeightEmoji = mRowHeightTempEmoji;
    ...
    public int getRowHeightEmoji() {
        return mRowHeightEmoji;
    }
