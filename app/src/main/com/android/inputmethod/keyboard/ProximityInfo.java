...
public class ProximityInfo {
    ...
    ProximityInfo(final int gridWidth, final int gridHeight, final int minWidth, final int height,
        ...
        mCellWidth = (minWidth + mGridWidth - 1) / (mGridWidth !=0 ? mGridWidth : 1);
        mCellHeight = (height + mGridHeight - 1) / (mGridHeight !=0 ? mGridHeight : 1);
...
*/
            ...
            int baseIndexOfCurrentRow = (yStart / heightTemp) * mGridWidth + (xStart / mCellWidth);
            for (int centerY = yStart; centerY <= yEnd; centerY += heightTemp) {
