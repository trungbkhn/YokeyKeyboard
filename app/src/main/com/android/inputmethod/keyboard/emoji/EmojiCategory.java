...
final class EmojiCategory {
    ...
    private static final int ID_PEOPLE = 2;
    private static final int ID_OBJECTS = 3;
    private static final int ID_NATURE = 4;
    private static final int ID_PLACES = 5;
    private static final int ID_SYMBOLS = 6;
    private static final int ID_EMOTICONS = 7;
    private static final int ID_FLAGS = 8;
    private static final int ID_EIGHT_SMILEY_PEOPLE = 9;
    private static final int ID_EIGHT_ANIMALS_NATURE = 10;
    private static final int ID_EIGHT_FOOD_DRINK = 11;
    private static final int ID_EIGHT_TRAVEL_PLACES = 12;
    private static final int ID_EIGHT_ACTIVITY = 13;
    private static final int ID_EIGHT_OBJECTS = 14;
    private static final int ID_EIGHT_SYMBOLS = 15;
    private static final int ID_EIGHT_FLAGS = 16;
    private static final int ID_EIGHT_SMILEY_PEOPLE_BORING = 17;
    private CompositeDisposable mCompositeDisposable = new CompositeDisposable();
    private DynamicGridKeyboard mRecentsKeyboard;
    private OnEmojiLoadDataListener mEmojiLoadDataListener;
    ...
    private static final int[] sCategoryTabIconAttr = {
            ...
            R.styleable.EmojiPalettesView_iconEmojiFavouriteTab,
    ...
    private static final int[] sAccessibilityDescriptionResourceIdsForCategories = {
            ...
            R.string.spoken_descrption_emoji_category_favourite,
    ...
    private static final int[] sCategoryElementId = {
            ...
            KeyboardId.ELEMENT_EMOJI_FAVOURITE,
    ...
    public EmojiCategory(final SharedPreferences prefs, final Resources res,
            final KeyboardLayoutSet layoutSet, final TypedArray emojiPaletteViewAttr, OnEmojiLoadDataListener mEmojiLoadDataListener) {
        this.mEmojiLoadDataListener = mEmojiLoadDataListener;
        mPrefs = prefs;
        mRes = res;
    ...
    private void loadEmoji() {
        ...
        addShownCategoryId(EmojiCategory.ID_FAVOURITE);
    ...
    private void addShownCategoryId(final int categoryId) {
        ...
        if(categoryId!=EmojiCategory.ID_FAVOURITE)getKeyboard(categoryId, 0 /* categoryPageId */);
        final CategoryProperties properties = new CategoryProperties(categoryId, categoryId!=EmojiCategory.ID_FAVOURITE ? getCategoryPageCount(categoryId) : 1);
    ...
    public void refreshEmoji() {
        ...
        Completable.fromAction(this::loadEmoji).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread()).doOnSubscribe(disposable -> {
            mCompositeDisposable.add(disposable);

        }).doOnComplete(() -> {
            if (mEmojiLoadDataListener != null) {
                mEmojiLoadDataListener.onEmojiRefresh();
            }
        }).subscribe();
    }
    ...
    public interface OnEmojiLoadDataListener {
        void onEmojiLoadDataFinish();
