...
public final class Suggest {
    ...
    public void getSuggestedWords(final WordComposer wordComposer,
        ...
        if (wordComposer.isBatchMode()) {
            Log.d("duongcv", "getSuggestedWords: 1");
            ...
            Log.d("duongcv", "getSuggestedWords: 2");
    ...
    private void getSuggestedWordsForNonBatchInput(final WordComposer wordComposer,
        ...
        //Todo: Duongcv get suggestion
        String text = wordComposer.getTypedWord();
        final String typedWordString = App.getInstance().fontRepository.font.removeFont(text);
        wordComposer.setTypedWord(typedWordString);
        Log.d("duongcv", "getSuggestedWordsForNonBatchInput: " + typedWordString +"::::::"+text);
