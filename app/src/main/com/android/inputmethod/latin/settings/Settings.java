...
//    public static final String SAVE_STATE_SHIFT_WHEN_CHANGE_SCREEN_EMOJI_STICKER_GIF = "SAVE_STATE_SHIFT_WHEN_CHANGE_SCREEN_EMOJI_STICKER_GIF";
    public static final String SAVE_STATE_AUTO_CAPS_WHEN_CHANGE_SCREEN_EMOJI_STICKER_GIF = "SAVE_STATE_AUTO_CAPS_WHEN_CHANGE_SCREEN_EMOJI_STICKER_GIF";
    ...
    public static final String PREF_KEYBOARD_CURRENT = "PREF_KEYBOARD_CURRENT";
    ...
    public void loadSettings(final Context context, final Locale locale,
        ...
        mSettingsValuesLock.lock();
        mContext = context;
        languageInputMethod = locale.getLanguage();
        languageKeyBoardCurrent = locale.getLanguage();
        try {
    ...
    public static String languageKeyBoardCurrent = Constant.KEYBOARD_LANGUAGE_ENGLISH;

    public static String getLanguageKeyBoardCurrent() {
       /* if(languageKeyBoardCurrent.length() == 0){
            return App.getInstance().mPrefs.getString(PREF_KEYBOARD_CURRENT,Constant.KEYBOARD_LANGUAGE_ENGLISH);//Constant.KEYBOARD_LANGUAGE_ENGLISH;
        }*/
        return App.getInstance().mPrefs.getString(PREF_KEYBOARD_CURRENT,Constant.KEYBOARD_LANGUAGE_ENGLISH);//languageKeyBoardCurrent
    }

    public static void setLanguageKeyBoardCurrent(String languageKeyBoardCurrent) {
        Timber.d("ducNQ : setLanguageKeyBoardCurrent: "+languageKeyBoardCurrent);
        Settings.languageKeyBoardCurrent = languageKeyBoardCurrent;
        App.getInstance().mPrefs.edit().putString(PREF_KEYBOARD_CURRENT,languageKeyBoardCurrent).apply();
    }

    public static String languageInputMethod = Constant.KEYBOARD_LANGUAGE_ENGLISH;
    public static Locale localeCurrentLanguage = Locale.getDefault();
    public static String getLanguageInputMethod() {
        return languageInputMethod;
    }
}
