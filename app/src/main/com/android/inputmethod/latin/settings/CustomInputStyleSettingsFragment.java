...
public final class CustomInputStyleSettingsFragment extends PreferenceFragment
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        Timber.d("ducNQ : onCreatesssss: ");
        setHasOptionsMenu(true);
        Log.d("duongcv", "onCreate: CustomInputStyleSettingsFragment");
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        //   view.setBackgroundColor(getContext().getColor(R.color.background_main));
        return view;
    }
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        mKeyboardLayoutSetAdapter = new CustomInputStylePreference.KeyboardLayoutSetAdapter(context);
        ...
        mIsAddingNewSubtype = (savedInstanceState != null) && savedInstanceState.containsKey(KEY_IS_ADDING_NEW_SUBTYPE);
        if (mIsAddingNewSubtype) {
            getPreferenceScreen().addPreference(CustomInputStylePreference.newIncompleteSubtypePreference(context, this));
        }
    ...
    private AlertDialog createDialog() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(DialogUtils.getPlatformDialogThemeContext(getActivity()));
    ...
    public void onCreateOptionsMenu(final Menu menu, final MenuInflater inflater) {
        LocaleUtils.INSTANCE.applyLocale(getActivity());
    ...
    public void onResume() {
        super.onResume();
        Log.d("duongcv", "onResume: CustomInputStyleSettingsFragment");
    }
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        if (itemId == R.id.action_add_style) {
            final CustomInputStylePreference newSubtype = CustomInputStylePreference.newIncompleteSubtypePreference(getActivity(), this);
