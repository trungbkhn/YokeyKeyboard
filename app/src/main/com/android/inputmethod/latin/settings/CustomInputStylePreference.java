...
final class CustomInputStylePreference extends DialogPreference
    ...
    protected View onCreateDialogView() {
      ...
      //  v.setBackgroundColor(getContext().getColor(R.color.background_main));
    ...
    protected void onPrepareDialogBuilder(final AlertDialog.Builder builder) {
        ...
        if (isIncomplete()) {
            ...
            setSpinnerKeyboard(mKeyboardLayoutSetSpinner, layoutItem);
        }
    }

    private static void setSpinnerKeyboard(final Spinner spinner, final KeyboardLayoutSetItem itemToSelect) {
        spinner.post(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < count; i++) {
                    KeyboardLayoutSetItem item = (KeyboardLayoutSetItem) spinner.getItemAtPosition(i);
                    if (item.mDisplayName.equals(itemToSelect.mDisplayName)) {
    ...
    private void setSpinnerPosition(Spinner spinner, CustomInputStylePreference.SubtypeLocaleItem itemToSelect) {
        spinner.post(new Runnable() {
            @Override
            public void run() {
                ...
                for (int i = 0; i < count; i++) {
                    CustomInputStylePreference.SubtypeLocaleItem item = (CustomInputStylePreference.SubtypeLocaleItem) spinner.getItemAtPosition(i);
    ...
    static final class SubtypeLocaleItem implements Comparable<SubtypeLocaleItem> {
        ...
        public SubtypeLocaleItem(final InputMethodSubtype subtype) {
            ...
            mDisplayName = SubtypeLocaleUtils.getSubtypeLocaleDisplayNameInSystemLocale(mLocaleString);
        }
