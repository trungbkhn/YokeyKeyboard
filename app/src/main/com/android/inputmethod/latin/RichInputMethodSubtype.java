...
public class RichInputMethodSubtype {
    ...
    public static boolean checkSubtype = false;
    ...
    public RichInputMethodSubtype(@Nonnull final InputMethodSubtype subtype) {
        ...
        if (mSubtype == null || mSubtype.getMode() == null || mSubtype.getLocale().isEmpty()){
            checkSubtype = true;
        }else {
            checkSubtype = false;
        }
    ...
    public static final int SUBTYPE_ID_OF_DUMMY_NO_LANGUAGE_SUBTYPE = 0xdde0bfd3;
    public static final String EXTRA_VALUE_OF_DUMMY_NO_LANGUAGE_SUBTYPE =
