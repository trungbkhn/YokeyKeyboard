...
public final class ViewLayoutUtils {
    ...
    public static void updateLayoutGravityOf(final View view, final int layoutGravity) {
        ...
        if (lp instanceof LinearLayout.LayoutParams) {
            ...
            Log.d("duongcv", "updateLayoutGravityOf: lin");
            ...
            params.width = ViewGroup.LayoutParams.MATCH_PARENT;//KeyboardSwitcher.getInstance().getWidthKeyboard();//DisplayUtils.getScreenWidth();
            Log.d("duongcv", "updateLayoutGravityOf: frame");
            if (params.gravity != layoutGravity) {
                params.gravity = layoutGravity;
                view.setLayoutParams(params);
            }
