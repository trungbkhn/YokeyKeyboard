...
public final class AdditionalSubtypeUtils {
    ...
    public static ArrayList<InputMethodSubtype> createAdditionalSubtypesArrayList(List<LanguageEntity> languageEntities) {
        if (languageEntities.size() == 0) {
            return new ArrayList<>();
        }
        final ArrayList<InputMethodSubtype> subtypesList = new ArrayList<>(languageEntities.size());
        for (final LanguageEntity languageEntity : languageEntities) {
            InputMethodSubtype inputMethodSubtype = createAdditionalSubtype(languageEntity.prefSubtype);
            if (inputMethodSubtype == null) {
                continue;
            }
            subtypesList.add(inputMethodSubtype);
        }
        return subtypesList;
    }
    ...
    public static InputMethodSubtype createAdditionalSubtype(String prefSubtype) {
        ...
        // 	return null;
        // }
        // return createAsciiEmojiCapableAdditionalSubtype(
        // 		localeString, keyboardLayoutSetName);
        return subtype;
    }
    ...
    public static InputMethodSubtype[] createAdditionalSubtypesArray(final String prefSubtypes) {
        ...
        Log.d("duongcv", "createAdditionalSubtypesArray: "+ subtypesList.toArray(new InputMethodSubtype[subtypesList.size()]));
