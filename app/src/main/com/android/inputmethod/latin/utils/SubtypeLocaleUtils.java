...
//    private static final String RESOURCE_PACKAGE_NAME = "com.android.inputmethod.latin";
    ...
    public static String getSubtypeDisplayNameInSystemLocale(
        ...
        if (sResources == null) return "Tiếng Anh (Anh) (QWERTY)";
        final Locale displayLocale = sResources.getConfiguration().locale;
    ...
    public static boolean isNoLanguage(final RichInputMethodSubtype subtype) {
        final String localeString = subtype.getLocale().toString();
