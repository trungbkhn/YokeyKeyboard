...
//    }
    ...
    public static String getMiddleDisplayName(final RichInputMethodSubtype subtype) {
        if (SubtypeLocaleUtils.isNoLanguage(subtype)) {
            return SubtypeLocaleUtils.getKeyboardLayoutSetDisplayName(subtype.toString()) ;
        }
        return SubtypeLocaleUtils.getSubtypeLanguageDisplayName(subtype.getLocale().toString());
    }
}
