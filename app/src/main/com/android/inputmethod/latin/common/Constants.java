...
public final class Constants {
    public static final String CHECK_REQUESTLAYOUT_MAINKEYBOARD="check_requestlayout_mainkeyboard";
    ...
    public static final int CODE_COMMA_OTHER_LANGUAGE = 0x060C;
    /**
    ...
    public static final int CODE_COMMA_KEY =44;
    public static final int CODE_PERIOD_KEY =46;
    ...
    public static final int CODE_ALPHA_FROM_EMOJI_SEARCH = -16;
    public static final int CODE_ALPHA_FROM_TRANSLATE = -17;
    /**
    ...
    public static final String ID_CATEGORY_RGB = "rgb";
    public static final String ID_CATEGORY_GRADIENT = "gradient";
    public static final String ID_CATEGORY_COLOR = "color";
    public static final String ID_CATEGORY_WALL = "background";
    public static final String ID_FEATURED = "featured";
