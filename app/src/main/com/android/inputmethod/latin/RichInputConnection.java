...
public final class RichInputConnection implements PrivateCommandPerformer {
    ...
    public ExtractedText getExtractedText() {
        ...
        r.token = 1;
        r.flags = 0;
        return mIC.getExtractedText(r, 0);
    }
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            mIC.commitText(mTempObjectForCommitText, 1);
        }
    }
    ...
    public CharSequence getTextBeforeCursor(final int n, final int flags) {
        ...
        if (INVALID_CURSOR_POSITION != mExpectedSelStart
            ...
            try {
                ...
                if (mComposingText != null && !mComposingText.toString().isEmpty()) {
    ...
    public void sendKeyEvent(final KeyEvent keyEvent) {
        if (DEBUG_BATCH_NESTING) checkBatchEdit();
        Timber.d("ducNQ : sendKeyEvented: "+keyEvent.getAction());
...
//            mIC.finishComposingText();
    ...
    public boolean isCursorTouchingWord(final SpacingAndPunctuations spacingAndPunctuations, boolean checkTextAfter) {
    ...
    public boolean revertDoubleSpacePeriod(final SpacingAndPunctuations spacingAndPunctuations) {
        ...
        Timber.e("hachung revertDoubleSpacePeriod:"+singleSpace);
    ...
    public boolean revertSwapPunctuation() {
        ...
        Timber.e("hachung revertSwapPunctuation:"+text);
        commitText(text, 1);
        return true;
    }
