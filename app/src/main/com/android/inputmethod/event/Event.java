...
public class Event {
    ...
    public CharSequence getTextToCommit() {
        ...
        case EVENT_TYPE_INPUT_KEYPRESS:
            if (textResultChangeFont != null) {
                return textResultChangeFont;
            }
    ...
    private CharSequence textResultChangeFont;
    public void setTextToCommit(CharSequence textResultChangeFont) {
        this.textResultChangeFont = textResultChangeFont;
    }
}
